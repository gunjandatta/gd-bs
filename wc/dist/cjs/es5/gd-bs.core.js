...
function t(n, t, e) { void 0 === e && (e = {}); var r = Array.isArray(t) ? t : [t], i = n.document, u = e.hydratedCssClass || "hydrated", f = e.exclude; f && (r = r.filter(function (n) { return -1 === f.indexOf(n[0]); })); var c = r.map(function (n) { return n[0]; }); if (c.length > 0) {
...
} var l = e.namespace || "GdBs"; return W || (W = !0, function v(n, t, e) { (n["s-apps"] = n["s-apps"] || []).push(t), e.componentOnReady || (e.componentOnReady = function t() { function e(t) { if (r.nodeName.indexOf("-") > 0) {
    ...
    gd_bs_global_js_1.default(l, f, n, i, c, u), T[l] = _(l, f, n, i, c, u, r);
...
var gd_bs_global_js_1 = require("./gd-bs.global.js");
...
var u = {}, f = function (n) { return null != n; }, c = function (n) { return n.toLowerCase(); }, a = function (n) { return c(n).split("-").map(function (n) { return n.charAt(0).toUpperCase() + n.slice(1); }).join(""); }, s = "http://www.w3.org/1999/xlink", l = function (n, t, e, r, i, o) { if ("class" !== e || o)
    if ("style" === e) {
        ...
        if ("list" !== e && "type" !== e && !o && (e in t || -1 !== ["object", "function"].indexOf(typeof i) && null !== i)) {
            var f = n.I(t);
            f && f.G && f.G[e] ? p(t, e, i) : "ref" !== e && (p(t, e, null == i ? "" : i), null != i && !1 !== i || n.Z.Y(t, e));
        }
        else
            null != i && "key" !== e ? function (n, t, e, r, i) { void 0 === r && (r = "boolean" == typeof e), i = t !== (t = t.replace(/^xlink\:?/, "")), null == e || r && (!e || "false" === e) ? i ? n.removeAttributeNS(s, c(t)) : n.removeAttribute(t) : "function" != typeof e && (e = r ? "" : e.toString(), i ? n.setAttributeNS(s, c(t), e) : n.setAttribute(t, e)); }(t, e, i) : (o || n.Z.J(t, e) && (null == i || !1 === i)) && n.Z.Y(t, e);
    else
        e = c(e) in t ? c(e.substring(2)) : c(e[2]) + e.substring(3), i ? i !== r && n.Z.K(t, e, i, 0) : n.Z.V(t, e, 0);
else if (r !== i) {
    ...
    case 12: return [2];
} }); }); }, A = function (n, t, e, r, i, o, u) { (u = n.jn.get(t)) || n.jn.set(t, u = {}), r !== u[e] && (u[e] = r, n.hn.get(t) && !n.gn && t["s-rn"] && k(n, t, i)); }, E = function (n, t, e, r) { Object.defineProperty(n, t, { configurable: !0, get: e, set: r }); }, C = function (n, t, e, r, i, o) { try {
    i = new (o = n.I(t).mn), function (n, t, e, r, i, o) { n.kn.set(r, e), n.jn.has(e) || n.jn.set(e, {}), Object.entries(Object.assign({ color: { type: String } }, t.properties, { mode: { type: String } })).forEach(function (t) { var u = t[0], c = t[1]; (function (n, t, e, r, i, o, u, c, a) { if (t.type) {
        var s = n.jn.get(e);
        !t.attr || void 0 !== s[i] && "" !== s[i] || (c = o && o.$n) && f(a = c[t.attr]) && (s[i] = j(t.type, a)), e.hasOwnProperty(i) && (void 0 === s[i] && (s[i] = j(t.type, e[i])), "mode" !== i && delete e[i]), r.hasOwnProperty(i) && void 0 === s[i] && (s[i] = r[i]), E(r, i, function l(t) { return (t = n.jn.get(n.kn.get(this))) && t[i]; }, function v(e, r) { (r = n.kn.get(this)) && t.mutable && A(n, r, i, e, u); });
    }
    else
    ...
    i = {}, n.bn(e, 7, t, !0);
} return n.hn.set(t, i), i; }, S = function (n, t) { for (var e = 0; e < t.childNodes.length; e++) {
...
} return !0; }, O = function (n, t, e, r, i, o) { if (n.ln.delete(t), (i = n.yn.get(t)) && ((r = i["s-ld"]) && ((e = r.indexOf(t)) > -1 && r.splice(e, 1), r.length || i["s-init"] && i["s-init"]()), n.yn.delete(t)), n.En.length && !n.ln.size)
    for (; o = n.En.shift();)
        o(); }, _ = function (t, e, r, i, o, u) { var a = r.performance, s = { html: {} }, l = r[t] = r[t] || {}, v = function (n, t, e) { var r = new WeakMap, i = { Cn: e, Sn: !!e.documentElement.attachShadow, On: !1, _n: function (n) { return n.nodeType; }, Tn: function (n) { return e.createElement(n); }, Wn: function (n, t) { return e.createElementNS(n, t); }, xn: function (n) { return e.createTextNode(n); }, Pn: function (n) { return e.createComment(n); }, Nn: function (n, t, e) { return n.insertBefore(t, e); }, Rn: function (n) { return n.remove(); }, Ln: function (n, t) { return n.appendChild(t); }, Dn: function (n, t) { if (n.classList)
        n.classList.add(t);
    else if ("svg" === n.nodeName.toLowerCase()) {
        var e = n.getAttribute("class") || "";
        e.split(" ").includes(t) || (e += " " + t), n.setAttribute("class", e.trim());
    } }, Fn: function (n) { return n.childNodes; }, Hn: function (n) { return n.parentNode; }, qn: function (n) { return n.nextSibling; }, Un: function (n) { return n.previousSibling; }, Bn: function (n) { return c(n.nodeName); }, In: function (n) { return n.textContent; }, Gn: function (n, t) { return n.textContent = t; }, Qn: function (n, t) { return n.getAttribute(t); }, Yn: function (n, t, e) { return n.setAttribute(t, e); }, Y: function (n, t) { return n.removeAttribute(t); }, J: function (n, t) { return n.hasAttribute(t); }, Zn: function (t) { return t.getAttribute("mode") || (n.Context || {}).mode; }, zn: function (n, r) { return "child" === r ? n.firstElementChild : "parent" === r ? i.Jn(n) : "body" === r ? e.body : "document" === r ? e : "window" === r ? t : n; }, K: function (t, e, o, u, f, c, a, s, l, v) { var p = t, d = o, h = r.get(t); v = e + u, h && h[v] && h[v](), "object" == typeof a && (p = a), p && (s = i.On ? { capture: !!f, passive: !!c } : !!f, n.ael(p, e, d, s), h || r.set(t, h = {}), h[v] = function () { p && n.rel(p, e, d, s), h[v] = null; }); }, V: function (n, t, e, i) { (i = r.get(n)) && (t ? i[t + e] && i[t + e]() : Object.keys(i).forEach(function (n) { i[n] && i[n](); })); }, Kn: function (n, e, r, i) { return i = new t.CustomEvent(e, r), n && n.dispatchEvent(i), i; }, Jn: function (n, t) { return (t = i.Hn(n)) && 11 === i._n(t) ? t.host : t; }, Vn: function (n, t, e, r) { return n.setAttributeNS(t, e, r); } }; return "function" != typeof t.CustomEvent && (t.CustomEvent = function (n, t, r) { return t = t || {}, (r = e.createEvent("CustomEvent")).initCustomEvent(n, t.bubbles, t.cancelable, t.detail), r; }, t.CustomEvent.prototype = t.Event.prototype), n.ael || (n.ael = function (n, t, e, r) { return n.addEventListener(t, e, r); }, n.rel = function (n, t, e, r) { return n.removeEventListener(t, e, r); }), i; }(l, r, i), p = v.Cn.documentElement, b = r["s-defined"] = r["s-defined"] || {}, m = { Z: v, o: function (n, t) { r.customElements.get(n.rn) || (function (n, t, e, r, i) { if (e.connectedCallback = function () { (function (n, t, e) { n.dn.delete(e), n.An.has(e) || (n.Xn = !0, n.ln.add(e), n.An.set(e, !0), function (n, t, e) { for (e = t; e = n.Z.Jn(e);)
        if (n.nt(e)) {
            n.tt.has(t) || (n.yn.set(t, e), (e["s-ld"] = e["s-ld"] || []).push(t));
            break;
        } }(n, e), n.queue.tick(function () { n.wn.set(e, function (n, t, e, r, i) { if (e.mode || (e.mode = n.Zn(e)), e["s-cr"] || n.Qn(e, "ssrv") || n.Sn && 1 === t.in || (e["s-cr"] = n.xn(""), e["s-cr"]["s-cn"] = !0, n.Nn(e, e["s-cr"], n.Fn(e)[0])), !n.Sn && 1 === t.in)
        try {
            !window.HTMLElement || "shadowRoot" in window.HTMLElement.prototype || (e.shadowRoot = e);
        }
        catch (n) { } return r = { $n: {} }, t.G && Object.keys(t.G).forEach(function (o) { (i = t.G[o].X) && (r.$n[i] = n.Qn(e, i)); }), r; }(n.Z, t, e)), n.et(t, e); })); })(n, t, this); }, e.disconnectedCallback = function () { (function (n, t) { !n.rt && function (n, t) { for (; t;) {
        if (!n.Hn(t))
            return 9 !== n._n(t);
        t = n.Hn(t);
    } }(n.Z, t) && (n.dn.set(t, !0), O(n, t), y(n.Mn.get(t), !0), n.Z.V(t), n.it.delete(t), n.s && n.s.removeHost(t), [n.yn, n.ot, n.wn].forEach(function (n) { return n.delete(t); })); })(n, this); }, e["s-init"] = function () { (function (n, t, e, r, i, o) { if (S(n, t) && n.hn.get(t) && !n.dn.has(t) && (!t["s-ld"] || !t["s-ld"].length)) {
        n.tt.set(t, !0), n.ut.has(t) || (n.ut.set(t, !0), t["s-ld"] = void 0, n.Z.Dn(t, e));
        try {
            y(n.Mn.get(t)), (o = n.ot.get(t)) && (o.forEach(function (n) { return n(t); }), n.ot.delete(t));
        }
        catch (e) {
            n.bn(e, 4, t);
        }
        O(n, t);
    } })(n, this, r); }, e.forceUpdate = function () { k(n, this, i); }, t.G) {
        var o = Object.entries(t.G), u = {};
        o.forEach(function (n) { var t = n[0], e = n[1].X; e && (u[e] = t); }), u = Object.assign({}, u), e.attributeChangedCallback = function (n, t, e) { (function r(n, t, e, i) { var o = n[c(e)]; o && (t[o] = (null !== i || "boolean" != typeof t[o]) && i); })(u, this, n, e); }, function (n, t, e, r) { o.forEach(function (t) { var i = t[0], o = t[1]; 3 & o.nn && E(e, i, function t() { return (n.jn.get(this) || {})[i]; }, function t(e) { A(n, this, i, j(o.en, e), r); }); }); }(n, 0, e, i);
    } }(m, s[n.rn] = n, t.prototype, u, a), t.observedAttributes = Object.values(n.G).map(function (n) { return n.X; }).filter(function (n) { return !!n; }), r.customElements.define(n.rn, t)); }, I: function (n) { return s[v.Bn(n)]; }, ft: function (n) { return e[n]; }, isClient: !0, nt: function (n) { return !(!b[v.Bn(n)] && !m.I(n)); }, bn: function (n, t, e) { return console.error(n, t, e && e.tagName); }, queue: e.queue = w(l, r), et: function (n, t) { var e = { mode: t.mode, scoped: !1 }; n.u(e).then(function (e) { try {
        n.mn = e;
    }
    catch (t) {
        console.error(t), n.mn = function r() { };
    } k(m, t, a); }); }, gn: !1, pn: !1, rt: !1, ct: void 0, yn: new WeakMap, at: new WeakMap, An: new WeakMap, it: new WeakMap, ut: new WeakMap, tt: new WeakMap, kn: new WeakMap, wn: new WeakMap, hn: new WeakMap, dn: new WeakMap, vn: new WeakMap, ot: new WeakMap, st: new WeakMap, Mn: new WeakMap, jn: new WeakMap, ln: new Set, En: [] }; return e.isServer = e.isPrerender = !(e.isClient = !0), e.window = r, e.location = r.location, e.document = i, e.resourcesUrl = e.publicPath = o, l.h = n, l.Context = e, l.onReady = function () { return new Promise(function (n) { return m.queue.write(function () { return m.ln.size ? m.En.push(n) : n(); }); }); }, m.render = function (n, t) { var e, r, i, o, u, c, a, s = function (i, v, p, y, w, b, m, g, M) { if (g = v.vchildren[p], e || (o = !0, "slot" === g.vtag && (r && t.Dn(y, r + "-s"), g.vchildren ? g.lt = !0 : g.vt = !0)), f(g.vtext))
    g.t = t.xn(g.vtext);
else if (g.vt)
    g.t = t.xn("");
else {
    if (b = g.t = h || "svg" === g.vtag ? t.Wn("http://www.w3.org/2000/svg", g.vtag) : t.Tn(g.lt ? "slot-fb" : g.vtag), n.nt(b) && n.tt.delete(a), h = "svg" === g.vtag || "foreignObject" !== g.vtag && h, d(n, null, g, h), f(r) && b["s-si"] !== r && t.Dn(b, b["s-si"] = r), g.vchildren)
        for (w = 0; w < g.vchildren.length; ++w)
            (m = s(i, g, w, b)) && t.Ln(b, m);
    "svg" === g.vtag && (h = !1);
} return g.t["s-hn"] = c, (g.lt || g.vt) && (g.t["s-sr"] = !0, g.t["s-cr"] = u, g.t["s-sn"] = g.vname || "", (M = i && i.vchildren && i.vchildren[p]) && M.vtag === g.vtag && i.t && l(i.t)), g.t; }, l = function (e, r, i, u) { n.rt = !0; var f = t.Fn(e); for (i = f.length - 1; i >= 0; i--)
    (u = f[i])["s-hn"] !== c && u["s-ol"] && (t.Rn(u), t.Nn(b(u), u, w(u)), t.Rn(u["s-ol"]), u["s-ol"] = null, o = !0), r && l(u, r); n.rt = !1; }, v = function (n, e, r, i, o, u, a, l) { var v = n["s-cr"]; for ((a = v && t.Hn(v) || n).shadowRoot && t.Bn(a) === c && (a = a.shadowRoot); o <= u; ++o)
    i[o] && (l = f(i[o].vtext) ? t.xn(i[o].vtext) : s(null, r, o, n)) && (i[o].t = l, t.Nn(a, l, w(e))); }, p = function (n, e, r, o) { for (; e <= r; ++e)
    f(n[e]) && (o = n[e].t, i = !0, o["s-ol"] ? t.Rn(o["s-ol"]) : l(o, !0), t.Rn(o)); }, y = function (n, t) { return n.vtag === t.vtag && n.vkey === t.vkey && ("slot" !== n.vtag || n.vname === t.vname); }, w = function (n) { return n && n["s-ol"] ? n["s-ol"] : n; }, b = function (n) { return t.Hn(n["s-ol"] ? n["s-ol"] : n); }, m = function (e, r, i) { var o = r.t = e.t, u = e.vchildren, c = r.vchildren; h = r.t && f(t.Jn(r.t)) && void 0 !== r.t.ownerSVGElement, h = "svg" === r.vtag || "foreignObject" !== r.vtag && h, f(r.vtext) ? (i = o["s-cr"]) ? t.Gn(t.Hn(i), r.vtext) : e.vtext !== r.vtext && t.Gn(o, r.vtext) : ("slot" !== r.vtag && d(n, e, r, h), f(u) && f(c) ? function (n, e, r, i, o, u, c, a) { for (var d = 0, h = 0, g = e.length - 1, M = e[0], j = e[g], k = i.length - 1, $ = i[0], A = i[k]; d <= g && h <= k;)
    if (null == M)
        M = e[++d];
    else if (null == j)
        j = e[--g];
        ...
        "slot" !== M.vtag && "slot" !== A.vtag || l(t.Hn(M.t)), m(M, A), t.Nn(n, M.t, t.qn(j.t)), M = e[++d], A = i[--k];
    else if (y(j, $))
        "slot" !== M.vtag && "slot" !== A.vtag || l(t.Hn(j.t)), m(j, $), t.Nn(n, j.t, M.t), j = e[--g], $ = i[++h];
    else {
        ...
        f(o) ? ((a = e[o]).vtag !== $.vtag ? c = s(e && e[h], r, o, n) : (m(a, $), e[o] = void 0, c = a.t), $ = i[++h]) : (c = s(e && e[h], r, h, n), $ = i[++h]), c && t.Nn(b(M.t), c, w(M.t));
    } d > g ? v(n, null == i[k + 1] ? null : i[k + 1].t, r, i, h, k) : h > k && p(e, d, g); }(o, u, r, c) : f(c) ? (f(e.vtext) && t.Gn(o, ""), v(o, null, r, c, 0, c.length - 1)) : f(u) && p(u, 0, u.length - 1)), h && "svg" === r.vtag && (h = !1); }, g = function (n, e, r, i, o, u, f, c) { for (i = 0, o = (r = t.Fn(n)).length; i < o; i++)
    if (e = r[i], 1 === t._n(e)) {
        if (e["s-sr"])
            for (f = e["s-sn"], e.hidden = !1, u = 0; u < o; u++)
                if (r[u]["s-hn"] !== e["s-hn"])
                    if (c = t._n(r[u]), "" !== f) {
                        if (1 === c && f === t.Qn(r[u], "slot")) {
                            e.hidden = !0;
                            break;
                        }
                    }
                    else if (1 === c || 3 === c && "" !== t.In(r[u]).trim()) {
                        e.hidden = !0;
                        break;
                    }
        g(e);
    } }, M = [], j = function (n, e, r, o, u, f, c, a, s, l) { for (u = 0, f = (e = t.Fn(n)).length; u < f; u++) {
    if ((r = e[u])["s-sr"] && (o = r["s-cr"]))
        for (a = t.Fn(t.Hn(o)), s = r["s-sn"], c = a.length - 1; c >= 0; c--)
            (o = a[c])["s-cn"] || o["s-nr"] || o["s-hn"] === r["s-hn"] || ((3 === (l = t._n(o)) || 8 === l) && "" === s || 1 === l && null === t.Qn(o, "slot") && "" === s || 1 === l && t.Qn(o, "slot") === s) && (M.some(function (n) { return n.pt === o; }) || (i = !0, o["s-sn"] = s, M.push({ dt: r, pt: o })));
    1 === t._n(r) && j(r);
} }; return function (f, s, l, v, p, d, h, y, w, b, k, $) { if (a = f, c = t.Bn(a), u = a["s-cr"], e = v, r = a["s-sc"], o = i = !1, m(s, l), o) {
    for (j(l.t), h = 0; h < M.length; h++)
        (y = M[h]).pt["s-ol"] || ((w = t.xn(""))["s-nr"] = y.pt, t.Nn(t.Hn(y.pt), y.pt["s-ol"] = w, y.pt));
    for (n.rt = !0, h = 0; h < M.length; h++) {
        for (y = M[h], k = t.Hn(y.dt), $ = t.qn(y.dt), w = y.pt["s-ol"]; w = t.Un(w);)
            if ((b = w["s-nr"]) && b && b["s-sn"] === y.pt["s-sn"] && k === t.Hn(b) && (b = t.qn(b)) && b && !b["s-nr"]) {
                $ = b;
                break;
            }
        (!$ && k !== t.Hn(y.pt) || t.qn(y.pt) !== $) && y.pt !== $ && (t.Rn(y.pt), t.Nn(k, y.pt, $));
    }
    n.rt = !1;
} return i && g(l.t), M.length = 0, l; }; }(m, v), p["s-ld"] = [], p["s-rn"] = !0, p["s-init"] = function () { m.tt.set(p, l.loaded = m.pn = !0), v.Kn(r, "appload", { detail: { namespace: t } }); }, function (n, t, e, r, i, o) { if (t.componentOnReady = function (t, e) { if (!t.nodeName.includes("-"))
    return e(null), !1; var r = n.I(t); if (r)
    if (n.tt.has(t))
        e(t);
    else {
        var i = n.ot.get(t) || [];
        i.push(e), n.ot.set(t, i);
    } return !!r; }, i) {
