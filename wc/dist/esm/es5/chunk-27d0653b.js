...
var Card = /** @class */ (function () {
    ...
    Card.prototype.componentDidLoad = function () { var t = []; if (this.body)
        ...
        } return $REST.Components.Card({ body: t, className: this.className, el: this.el.children[0], footer: this.footer, header: this.header, imgBottom: this.imgBottom, imgTop: this.imgTop }); };
