...
var Jumbotron = /** @class */ (function () {
    ...
    Jumbotron.prototype.componentDidLoad = function () {
        ...
        return $REST.Components.Jumbotron({ className: this.className, content: this.content, el: this.el.children[0], isFluid: this.isFluid, lead: this.lead, title: this.el.getAttribute("title"), onRenderContent: function () {
                var e = [];
