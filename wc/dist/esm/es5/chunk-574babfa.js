...
var Alert = /** @class */ (function () {
    ...
    Alert.prototype.componentDidLoad = function () { return GD.Components.Alert({ className: this.className, content: this.content, el: this.el, header: this.header, isDismissible: this.isDismissible, type: this.type }); };
