...
var Progress = /** @class */ (function () {
    ...
    Progress.prototype.componentDidLoad = function () { return $REST.Components.Progress({ className: this.className, el: this.el.children[0], isAnimated: this.isAnimated, isStriped: this.isStriped, label: this.label, max: this.max, min: this.min, size: this.size }); };
