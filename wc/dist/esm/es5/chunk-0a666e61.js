...
var Pagination = /** @class */ (function () {
    ...
    Pagination.prototype.componentDidLoad = function () {
        ...
        return $REST.Components.Pagination({ alignment: this.alignment, className: this.className, el: this.el.children[0], icon: this.icon, isLarge: this.isLarge, isSmall: this.isSmall, label: this.label, numberOfPages: this.numberOfPages, onClick: function () {
                var e = [];
