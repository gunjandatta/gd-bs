...
var ListGroup = /** @class */ (function () {
    ...
    ListGroup.prototype.componentDidLoad = function () { var t = []; if (this.items)
        ...
        } return $REST.Components.ListGroup({ className: this.className, colWidth: this.colWidth, el: this.el.children[0], enableFade: this.enableFade, isFlush: this.isFlush, isTabs: this.isTabs, items: t }); };
