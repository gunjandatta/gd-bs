...
var ButtonGroup = /** @class */ (function () {
    ...
    ButtonGroup.prototype.componentDidLoad = function () { this.el.removeAttribute("id"); var t = []; if (this.buttons)
        ...
        } return $REST.Components.ButtonGroup({ buttons: t, buttonType: this.buttonType, className: this.className, el: this.el.children[0], id: this.id, isLarge: this.isLarge, isSmall: this.isSmall, isVertical: this.isVertical, label: this.label }); };
