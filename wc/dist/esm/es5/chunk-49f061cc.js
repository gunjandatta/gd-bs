...
var Navbar = /** @class */ (function () {
    ...
    Navbar.prototype.componentDidLoad = function () {
        ...
        return GD.Components.Navbar({ brand: this.brand, brandUrl: this.brandUrl, className: this.className, el: this.el.children[0], id: this.id, items: t, searchBox: e, type: this.type });
    };
